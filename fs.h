...
// Prototypes indispensables pour le compilateur
...
void read_file(Directory* dir, const char* name);         // Ajouté
void write_to_file(Directory* dir, const char* name, const char* new_content);
void delete_file(Directory* dir, const char* name);       // Ajouté
void check_space(Directory* root);                        // Ajouté
